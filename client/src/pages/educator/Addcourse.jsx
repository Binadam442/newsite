        ...
        <div className="h-screen overflow-scroll flex flex-col items-start justify-between 
         md:p-8 md:pb-0 p-4 pt-8 pb-0">
            ...
            <div className="flex flex-col gap-1">
                   ...
                   type="text" placeholder="Type here" className="outline-none md:py-2.5 py-2 px-3 
                ...
                <div>
                    {chapters.map((chapter, chapterIndex) =>(
                        <div key={chapterIndex} className="bg-white border rounded-lg mb-4 mt-2">
                            <div className="flex justify-between item-center p-4 border-b">
                                <div flex items-center>
                                    ...
                                    className={`mb-2 cursor-pointer transition-all ${chapter.collapsed && ".rotate-90"}`} />
                            ...
                            {!chapter.collapsed && (
                                ...
                                rounded cursor-pointer mt-4" onClick={()=> handleLecture('add', chapter.
                                   chapterId)}>+ Add Lecture</div>
                                </div>
                            )}
                        </div>
                    ))}
                    <div className="flex justify-center items-center bg-blue-100 p-2 mt-2 
                        ...
                        bg-opacity-50">
                            <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-80">
                                ...
                                <div className="mb-2">
                                    ...
                                    <input
                                    type="text" 
                                    className="mt-1 block w-full border rounder
                                    py-1 px-2"
