...
const Coursedetail = () => {
    ...
    const { allCourses, calculateRating, calculateChapterTime, currency,  
        calculateNoOfLectures,calculateCourseDuration, backendUrl, userData, getToken} = useContext(AppContext);
    ...
    return courseData ? (
        ...
        <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
            ...
            {/* Left Column */}
            <div className="md:w-1/2 w-full max-w-xl z-10 text-gray-500">
                        ...
                        {courseData.courseContent.map((chapter, index) => (
                            <div key={index} className="border border-gray-300 bg-white mb-2 rounded">
                                ...
                                <div className={`overflow-hidden transition-all duration-300 ${openSections[index] ? 'max-h-96' : 'max-h-0'}`}>
                                    <ul className="list-disc md:pt-10 pl-4 py-2 text-gray-600 border-t border-gray-300">
            ...
            overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
               ...
               :  <img className="w-full object-cover rounded-lg" src={courseData.courseThumbnail} alt="Course Thumbnail" />  
                }
