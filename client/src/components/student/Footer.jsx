        ...
        <footer className="bg-gray-900 md:px-36 text-left w-full mt-10">
            ...
            gap-10 md:gap-32 py-10 border-b border-white/30">
               <div className="flex flex-col md:items-start items-center w-full">
                <img className="font-semibold text-white mb-5 bg-blue-600" src="Sudemy" alt="Sudemy" />
            ...
            <p className="py-4 text-center text-xs md:text-sm text-white/60">Copyright 2025 @ Sudemy. All Right Reserved</p>
        </footer>
    )
}
